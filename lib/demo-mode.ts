 ...
 * only reason that module touched `document`, and because `@crewchief/core/routes`
 ...
 * `isDemoVehicleId` in `@crewchief/core/demo` is the check that matters on the server
 * regardless.
 *
...
import { DEMO_COOKIE } from '@crewchief/core/demo';
